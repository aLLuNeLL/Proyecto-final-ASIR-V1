En este comprimido zip encontrarás la base de datos con el código. De la carpeta php, se encuentran 2 conexion.php. El conexion1.php es el archivo de conexión php del servidor, y el archivo conexion.php es el archivo para la comprobación en xampp.
